                  ...
                  <div class="user-profile">
                    <div class="up-head-w" style="background-image:url(<?php echo base_url();?>public/uploads/bglogin.jpg)">
                      <div class="up-main-info">
                        ...
                        <h3 class="text-white">
                          <?php echo $this->crud->get_name('accountant',$row['accountant_id']);?>
                        </h3>
                        ...
                        <div class="col-lg-6">
                          <div class="value-pair">
                            ...
                            <div class="value badge badge-pill badge-primary">
                              <?php echo getEduAppGTLang('accountant');?>
                            </div>
                          </div>
                          <div class="value-pair">
                    ...
                    <div class="ui-block">
                      ...
                      <div class="ui-block-content">
                        <?php echo form_open(base_url() . 'accountant/my_profile/update_profile/', array('enctype' => 'multipart/form-data'));?>
                          <div class="row">   
                            <div class="col-sm-6">
                              ...
                              <ul class="help-support-list">
                                <li>
                                  <i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                    <a href="<?php echo base_url();?>accountant/my_profile/"><?php echo getEduAppGTLang('personal_information');?>
                                    </a>
                                </li>
                                <li>
                                  <i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                  <a href="<?php echo base_url();?>accountant/accountant_update/"><?php echo getEduAppGTLang('update_information');?>
                                  </a>
                                </li>
                              </ul>
                            </div>
