    <div class="full-chat-middle">
        <div class="chat-head">
            <a class="back-to-index d-xl-none d-md-none megasize" href="<?php echo base_url();?>accountant/group/"><i class="icon-feather-chevron-left"></i></a>          
            <div class="user-info">
        ...
        <div class="chat-controls b-b">
            <?php echo form_open(base_url() . 'accountant/group/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
