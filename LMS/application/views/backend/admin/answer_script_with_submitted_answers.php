...
?>
    ...
    <div class="back" style="margin-top:-20px;margin-bottom:10px">		
	    <a href="<?php echo base_url();?>admin/exam_results/<?php echo $param2;?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>	
	</div>
    <?php
        ...
        <div class="pipeline white lined-danger">            
          ...
          <?php elseif($question_type == 'true_false'):
              if ($row['submitted_answer'] != "") {
                  $submitted_answer = getEduAppGTLang($row['submitted_answer']);
              }
              else{
                  $submitted_answer = getEduAppGTLang('no_reply');
              }
