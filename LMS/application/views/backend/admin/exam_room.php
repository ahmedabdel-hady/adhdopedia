                ...
                <div class="os-tabs-w menu-shad">
                    <div class="os-tabs-controls">
                        <ul class="navs navs-tabs upper">
                            <li class="navs-item">
                                <a class="navs-links active" href="<?php echo base_url();?>admin/examroom/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo getEduAppGTLang('exam_details');?></span></a>
                            </li>
                            <li class="navs-item">
                                <a class="navs-links" href="<?php echo base_url();?>admin/exam_results/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo getEduAppGTLang('results');?></span></a>
                            </li>
                            <li class="navs-item">
                                                ...
                                                <?php if (sizeof($added_question_info) == 0):?>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <span class="badge badge-success">
                                                                <?php 
                                                                    if($added_question['type'] == "fill_in_the_blanks") {
                                                                        ...
                                                                        echo getEduAppGTLang('multilpe_choice');
                                                        ...
                                                        <td style="text-align: center;">
                                                            ...
                                                            <a href="<?php echo base_url();?>admin/delete_question_from_online_exam/<?php echo $added_question['question_bank_id'];?>" onclick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" title="<?php echo getEduAppGTLang('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            ...
                                            <table  class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b><?php echo getEduAppGTLang('time');?></b></td>
    ...
    <script type="text/javascript">
        $(document).ready(function() 
        {
            $('#question_type').on('change', function() {
                ...
                if (question_type == '') {
                    $('#question_holder').html('<div class="alert alert-danger"><?php echo getEduAppGTLang('select_question_type');?></div>');
                    return;
                }
