...
<?php $fc_info_data = base64_decode($data); $fc_ex = explode("-", $fc_info_data);?>
    ...
    <?php endif;?>
        <div class="header-content-wrapper" <?php if($page_name != 'cursos'):?> style="padding-left: 85px;" <?php endif;?>>
                ...
                <div class="author-page author vcard inline-items more">
                    ...
                    <a href="javascript:void(0);" class="author-name fn">
                        <div class="author-title">
                            <?php echo $this->crud->get_name('admin', $this->session->userdata('login_user_id'));?> <svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo base_url();?>public/style/olapp/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                        </div>
