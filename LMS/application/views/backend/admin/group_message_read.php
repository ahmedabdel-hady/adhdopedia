    <div class="full-chat-middle">
        <div class="chat-head">
            ...
            <div class="user-info">
                ...
                <a class="btn btn-success btn-sm" href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/group_info/<?php echo $row['group_message_thread_code'];?>');"><?php echo getEduAppGTLang('group_members');?></a>
            </div>
        </div>
            ...
            <div class="chat-content">
                ...
                <div class="chat-message">
                    <div class="chat-message-content-w">
                        <div class="chat-message-content">
                            ...
                            <?php if($row['attached_file_name'] != ""):?><br>
                                 <a class="badge badge-primary bg-white" target="_blank" href="<?php echo base_url();?>public/uploads/group_messaging_attached_file/<?php echo $row['attached_file_name'];?>"><i class="picons-thin-icon-thin-0105_download_clipboard_box"></i>&nbsp;&nbsp;<?php echo $row['attached_file_name'];?></a>
                              <?php endif;?>
                        </div>
                    </div>
                    ...
                    <div class="chat-message-date">
                        <span class="badge badge-primary"><?php echo $this->crud->get_name($sender_account_type,$sender_id);?></span><br>
                ...
                <div class="chat-message self">
                    <div class="chat-message-content-w">
                        <div class="chat-message-content">
                            <?php echo $row['message']; ?>
                            <?php if($row['attached_file_name'] != ""):?><br>
                             <a class="badge badge-primary text-white" target="_blank" href="<?php echo base_url();?>public/uploads/group_messaging_attached_file/<?php echo $row['attached_file_name'];?>"><i class="picons-thin-icon-thin-0105_download_clipboard_box"></i>&nbsp;&nbsp;<?php echo $row['attached_file_name'];?></a>
                          <?php endif;?>
                        </div>
                    </div>
                    <div class="chat-message-date">
        ...
        <div class="chat-info-section">
            ...
            <div class="ci-content  mCustomScrollbar">
                ...
                ?>
					...
					<?php else:?>
					    <span><?php echo getEduAppGTLang('without_shared_photos');?></span>
					<?php endif;?>
                </div>
            </div>
        </div>
