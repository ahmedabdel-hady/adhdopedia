<?php 
    $accountant = $this->db->get_where('accountant' , array('accountant_id' => $param2))->result_array();
...
?>
    <div class="modal-body">
        ...
        <div class="ui-block-content">
            <?php echo form_open(base_url() . 'admin/accountant/update/'.$row['accountant_id'], array('enctype' => 'multipart/form-data'));?>
                <div class="row">
