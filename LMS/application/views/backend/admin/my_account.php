                						    ...
                						    <div class="help-support-block">
											    ...
											    <ul class="help-support-list">
    												<li>
    													...
    													<a href="<?php echo base_url();?>admin/my_account/"><?php echo getEduAppGTLang('personal_information');?></a>
    												</li>
												    <li>
    													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													    <a href="<?php echo base_url();?>admin/update_account/"><?php echo getEduAppGTLang('update_information');?></a>
												    </li>
											    </ul>
										    </div>
									    </div>
									    <h4 class="text-center"><?php echo getEduAppGTLang('your_linked_accounts');?></h4>
                                        <?php $photo  = $this->crud->getUserSocial('admin', 'fb_photo');?>
                                        <?php $name   = $this->crud->getUserSocial('admin', 'fb_name');?>
                                        <?php $id     = $this->crud->getUserSocial('admin', 'fb_id');?>
                                        <?php $gid    = $this->crud->getUserSocial('admin', 'g_oauth');?>
                                        <?php $fname  = $this->crud->getUserSocial('admin', 'g_fname');?>
                                        <?php $lname  = $this->crud->getUserSocial('admin', 'g_lname');?>
                                        <?php $gphoto = $this->crud->getUserSocial('admin', 'g_picture');?>
                                        <?php $gemail = $this->crud->getUserSocial('admin', 'g_email');?>
                                        <div class="pricing-plans row no-gutters">
                                            <div class="pricing-plan col-sm-6">
                                                ...
                                                <div class="plan-body"><br><br>
                                                    ...
                                                    <?php else:?>
                                                        <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>admin/my_account/remove_facebook/"><?php echo getEduAppGTLang('unlink');?></a>
                                                    <?php endif;?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pricing-plan col-sm-6">
                                                ...
                                                <div class="plan-body"><br><br>
                                                    ...
                                                    <?php else:?>
                                                        <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>admin/my_account/remove_google/"><?php echo getEduAppGTLang('unlink');?></a>
                                                    <?php endif;?>
                                                    </div>
                                                </div>
                                            </div>
