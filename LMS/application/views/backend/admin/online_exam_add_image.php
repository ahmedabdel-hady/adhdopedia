    <?php echo form_open(base_url() . 'admin/manage_online_exam_question/'.$online_exam_id.'/add/image' , array('enctype' => 'multipart/form-data'));?>
    ...
    <script type="text/javascript">
	    function showOptions(number_of_options){
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/manage_image_options",
