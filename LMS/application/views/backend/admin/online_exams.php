            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/online_exams/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0207_list_checkbox_todo_done"></i><span><?php echo getEduAppGTLang('online_exams');?></span></a>
                        </li>
                        <li class="navs-item">
                                            ...
                                            <table class="table table-padded">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="bolder">
                                                            <a href="<?php echo base_url();?>admin/examroom/<?php echo $row['online_exam_id'];?>" class="btn btn-success btn-sm"> <?php echo getEduAppGTLang('details');?></a><br>
                                                            <?php if ($row['status'] == 'pending'): ?>
                                                            <a href="<?php echo base_url();?>admin/manage_online_exam_status/<?php echo $row['online_exam_id'];?>/published/<?php echo $data;?>/" onclick="return confirm('<?php echo getEduAppGTLang('confirm_publish');?>')" class="btn btn-info btn-sm"><?php echo getEduAppGTLang('publish_exam');?></a><br>
                                                            <?php elseif ($row['status'] == 'published'): ?>
                                                            <a href="<?php echo base_url();?>admin/manage_online_exam_status/<?php echo $row['online_exam_id'];?>/expired/<?php echo $data;?>/" onclick="return confirm('<?php echo getEduAppGTLang('confirm_expired');?>')" class="btn btn-primary btn-sm"> <?php echo getEduAppGTLang('mark_as_expired');?></a><br>
                                                            <?php elseif($row['status'] == 'expired'): ?>
                                                            <a href="javascript:void(0);" class="btn btn-warning btn-sm"> <?php echo getEduAppGTLang('expired');?></a><br>
                                                            <?php endif; ?>
                                                            <a class="btn btn-danger btn-sm" onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')" href="<?php echo base_url();?>admin/online_exams/delete/<?php echo $row['online_exam_id'];?>/<?php echo $data;?>/"><?php echo getEduAppGTLang('delete');?></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
