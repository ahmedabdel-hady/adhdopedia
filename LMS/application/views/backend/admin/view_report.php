	                    ...
	                    <div class="col-sm-8">
		                    <div class="pipeline white lined-primary">
			                    ...
			                    <div class="b-t padded-v-big">
			                        <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url();?>public/uploads/reportes_alumnos/<?php echo $row['file'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo getEduAppGTLang('download');?></a></td>
			                        <?php if($row['status'] == 0):?><br><br>
			                        <div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success" onClick="return confirm('<?php echo getEduAppGTLang('confirm_solved');?>')" href="<?php echo base_url();?>admin/view_report/update/<?php echo $row['report_code'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo getEduAppGTLang('mark_solved');?></a></div>
			                        <?php endif;?>
			                    </div>
		                    </div>
