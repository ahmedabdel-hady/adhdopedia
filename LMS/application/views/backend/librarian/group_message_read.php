    <div class="full-chat-middle">
        <div class="chat-head">
            <a class="back-to-index d-xl-none d-md-none megasize" href="<?php echo base_url();?>librarian/group/"><i class="icon-feather-chevron-left"></i></a>          
            <div class="user-info">
                ...
                <a class="btn btn-success btn-sm" href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/group_info/<?php echo $current_message_thread_code;?>');"><?php echo getEduAppGTLang('group_members');?></a>
            </div>
        </div> 
        ...
        <div class="chat-controls b-b">
            <?php echo form_open(base_url() . 'librarian/group/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
