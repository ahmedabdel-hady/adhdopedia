                    ...
                    <div class="row">        
                        <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                            ...
                            <?php if($wall['type'] == 'polls'):?>
                                <?php echo form_open(base_url() . 'librarian/polls/response/' , array('enctype' => 'multipart/form-data'));?>
                                <?php 
                                            ...
                                            <div class="ui-block-title"><h6 class="title"><?php echo getEduAppGTLang('chat_groups');?></h6></div>
                                                ...
                                                <li class="inline-items">
                                                    ...
                                                    <div class="notification-event">
                                                        <a href="<?php echo base_url();?>librarian/group/group_message_read/<?php echo $row['group_message_thread_code'];?>/" class="h6 notification-friend"><?php echo $row['group_name'];?></a>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header" role="tab" id="headingOne-1">
                                                            <div class="event-time">
                                                                <h5 class="mb-0 title">
                                                                    <a href="<?php echo base_url();?>librarian/calendar/"><?php echo $event['title'];?></a>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function vote(poll_code)
        {
            ...
            if(answer!="" && poll_code!="")
            {
                $.ajax({url:"<?php echo base_url();?>librarian/polls/response/",type:'POST',data:{answer:answer,poll_code:poll_code},success:function(result)
                {
