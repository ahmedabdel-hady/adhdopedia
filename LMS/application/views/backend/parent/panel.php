                                    ...
                                    <div class="sidebar__inner">
                                        ...
                                        <div class="ui-block paddingtel">
                                            <div class="widget w-create-fav-page">
                                                ...
                                                <div class="content">
                                                    <h3 class="title"><?php echo getEduAppGTLang('welcome_message_parent');?></h3>
                                                    <a href="<?php echo base_url();?>parents/progress/" class="btn btn-warning btn-sm"><?php echo getEduAppGTLang('go_to_timeline');?></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ui-block paddingtel">
                                            <div class="ui-block-title"><h6 class="title"><?php echo getEduAppGTLang('chat_groups');?></h6></div>
                                                ...
                                                <li class="inline-items">
                                                    ...
                                                    <div class="notification-event">
                                                        <a href="<?php echo base_url();?>parents/group/group_message_read/<?php echo $row['group_message_thread_code'];?>/" class="h6 notification-friend"><?php echo $row['group_name'];?></a>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header" role="tab" id="headingOne-1">
                                                                <div class="event-time">
                                                                    <h5 class="mb-0 title">
                                                                        <a href="<?php echo base_url();?>parents/calendar/"><?php echo $event['title'];?></a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </div>
