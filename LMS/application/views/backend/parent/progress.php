                        ...
                        <div class="tab-pane <?php if($active == 1) echo 'active';?>" id="<?php echo $row2['username'];?>">
                            ...
                            <div class="con tent-box" style="margin-top: 50px;width: 100%;">
			                    <div class="todo-app-w">
                                    <div class="todo-content" style="border-radius:20px;">
                                        ...
                                        ?>
                                            <div class="tasks-section">
                                                <div class="tasks-header-w" <?php $var_day = explode('-',$week_days[$i]); if($var_day[2] == date('d')):?>style="background: #a01a7a; border-radius: 12px; padding: 10px;"<?php endif;?>>
                                                    ...
                                                    <span class="tasks-sub-header" style="color:<?php $var_day = explode('-',$week_days[$i]); if($var_day[2] == date('d')):?> #ffffff; <?php else:?>rgba(0, 0, 0, 0.7);<?php endif;?>font-size: 0.95rem;">-  &nbsp;&nbsp;<?php $var_day = explode('-',$week_days[$i]); $originalDate = $var_day[1].'/'. $var_day[2].'/'.date('Y');
                                                    ...
                                                    <?php foreach($arrs as $row): ?>
                                                        <li class="draggable-task <?php echo $this->crud->check_li_status($row['wall_type'],$row['homework_id'],$row2['student_id']);?>">
                                                            ...
                                                            <?php if($row['wall_type'] == 'exam'):?>
                                                                ...
                                                                ?>
                                                                <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo date('d/m/Y', $row['date_end']);?>. <br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>parents/online_exams/<?php echo $redirect;?>/' target='_blank'><?php echo getEduAppGTLang('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0207_list_checkbox_todo_done" title="<?php echo getEduAppGTLang('online_exam');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                            <?php elseif($row['wall_type'] == 'homework'):?>
                                                                <?php 
                                                                    ...
                                                                    $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                                ?>
                                                                <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['date_end'];?>.<br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>parents/homeworkroom/<?php echo $redirect;?>/' target='_blank'><?php echo getEduAppGTLang('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0004_pencil_ruler_drawing" title="<?php echo getEduAppGTLang('homework');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                            <?php elseif($row['wall_type'] == 'forum'):?>
                                                                <?php 
                                                                    ...
                                                                    $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                                ?>
                                                                <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>parents/forumroom/<?php echo $redirect;?>/' target='_blank'><?php echo getEduAppGTLang('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation" title="<?php echo getEduAppGTLang('forum');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
