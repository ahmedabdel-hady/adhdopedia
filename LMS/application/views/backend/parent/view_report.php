        ...
        <div class="conty">
            <div class="content-i">
                <div class="content-box">
                    <div class="back">
		                <a href="<?php echo base_url();?>parents/student_report/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
	                </div>
	                <div class="row">
	                    <div class="col-sm-8">
	                    ...
	                    <div class="col-sm-4">
	        	            ...
	        	            <?php $user1 = $row['user_id']; $user = explode("-", $user1);?>
                                <div class="ui-block-content">
                                    <div class="widget w-about" style="text-align:center">
                                        <a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud->get_image_url($user[0], $user[1]);?>" style="width:90px;"></a>
