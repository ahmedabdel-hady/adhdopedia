    <div class="full-chat-middle">
        <div class="chat-head">
            <a class="back-to-index d-xl-none d-md-none megasize" href="<?php echo base_url();?>student/message/"><i class="icon-feather-chevron-left"></i></a>          
            <div class="user-info">
