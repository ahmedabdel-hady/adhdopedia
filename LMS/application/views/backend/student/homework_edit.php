                ...
                <div class="content-box">
	                ...
	                <div class="row">
	                    <div class="col-sm-8">
			                ...
			                <?php if($row['type'] != 1):?>
    			                <div class="b-t padded-v-big">
    			                    <?php echo form_open(base_url() . 'student/delivery/update_file/'.$delivery_id.'/'.$homework_code , array('enctype' => 'multipart/form-data'));?>
    			                        ...
    			                        <div class="row">
    			                            <div class="col-sm-12">
                                                <textarea class="form-control" placeholder="<?php echo getEduAppGTLang('send_teacher_comment');?>" name="comment" rows="5" style="width:100%"><?php echo $query->row()->student_comment;?></textarea>
			                ...
			                <?php if($row['type'] == 1):?>
			                    ...
			                    <?php echo form_open(base_url() . 'student/delivery/update_text/'.$delivery_id.'/'.$homework_code);?>
			                        <div class="b-t padded-v-big">
			                            <textarea cols="80" id="ckeditor1" required="" name="reply" rows="10"><?php echo $query->row()->homework_reply;?></textarea>
			                            <input type="hidden" name="class_id" value="<?php echo $row['class_id'];?>"> 
			                            <input type="hidden" name="section_id" value="<?php echo $row['section_id'];?>">
			                            <input type="hidden" name="subject_id" value="<?php echo $row['subject_id'];?>">
			                            <br>
