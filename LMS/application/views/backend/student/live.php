                                            ...
                                            <div class="ui-block">
                                                <div class="birthday-item inline-items badges">
                                                    <div class="birthday-author-name">
                                                        <a href="<?php echo base_url();?>student/live/<?php echo base64_encode($rowx['live_id']);?>" class="h6 author-name"><?php echo $rowx['title'];?> - <span class="badge badge-success"><?php echo $this->db->get_where('subject', array('subject_id' => $rowx['subject_id']))->row()->name;?></span> <small>[<?php echo $row['date'];?>].</small></a>
