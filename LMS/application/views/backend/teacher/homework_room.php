            ...
            <div class="os-tabs-w menu-shad">
		        <div class="os-tabs-controls">
		            <ul class="navs navs-tabs upper">
			            <li class="navs-item">
			                <a class="navs-links active" href="<?php echo base_url();?>teacher/homeworkroom/<?php echo $homework_code;?>/"><i class="os-icon picons-thin-icon-thin-0014_notebook_paper_todo"></i><span><?php echo getEduAppGTLang('homework_details');?></span></a>
			            </li>
			            <li class="navs-item">
                                    ...
                                    <article class="hentry post thumb-full-width">                
                                        <div class="post__author author vcard inline-items">
                                            ...
                                            <div class="author-date">
                                                <a class="h6 post__author-name fn" href="#"><?php echo $this->crud->get_name($row['uploader_type'], $row['uploader_id']);?></a>
                                            ...
                                            <div class="more">
                                                ...
                                                <ul class="more-dropdown">
                                                    <li><a href="<?php echo base_url();?>teacher/homework_edit/<?php echo $row['homework_code'];?>/"><?php echo getEduAppGTLang('edit');?></a></li>
                                                    <li><a href="<?php echo base_url();?>teacher/homework_details/<?php echo $row['homework_code'];?>/"><?php echo getEduAppGTLang('deliveries');?></a></li>
                                                </ul>
                                            </div>                
                                        </div>                
                                        <div class="edu-posts cta-with-media verde">
                                            <div class="cta-content">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left cell-with-media" >
                                                                    <a href="<?php echo base_url() . 'public/uploads/homework/' . $row['file_name']; ?>"><img src="<?php echo base_url();?>public/uploads/icons/file.svg" style="height: 25px;"><span><?php echo $row['file_name'];?></span><span class="smaller">(<?php echo $row['filesize'];?>)</span></a>
                                                                </td>             
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <?php endif;?>
                                                <div class="deadtime">
                                                    <span><?php echo getEduAppGTLang('date');?>:</span><i class="picons-thin-icon-thin-0027_stopwatch_timer_running_time"></i><?php echo $row['date_end'];?> @ <?php echo $row['time_end'];?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="control-block-button post-control-button">
                                            <a href="#" class="btn btn-control featured-post" style="background-color: #99bf2d; color: #fff;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('homework');?>">
