                            ...
                            <div class="ui-block features-video">
                                ...
                                <div class="features-video-content">
                                    <article class="hentry post">
                                        ...
                                        <?php
                    		                $info = $this->academic->getOtherLiveClassesForTeacher($row['live_id'], $row['class_id'], $row['section_id'],$row['subject_id']);
                    		                if(count($info) > 0):
                                        ...
                                        <div class="ui-block">
                                            <div class="birthday-item inline-items badges">
                                                <div class="birthday-author-name">
                                                    <a href="<?php echo base_url();?>teacher/live/<?php echo base64_encode($rowx['live_id']);?>" class="h6 author-name"><?php echo $rowx['title'];?> - <span class="badge badge-success"><?php echo $this->db->get_where('subject', array('subject_id' => $rowx['subject_id']))->row()->name;?></span> <small>[<?php echo $row['date'];?>].</small></a>
    ...
    <script>
        ...
        var options = {
            userInfo : { 
                ...
                displayName : '<?php echo $this->crud->get_name('teacher', $this->session->userdata('login_user_id'));?>',
                moderator: true,
            },
