...
?>
    <div class="full-chat-middle">
        <div class="chat-head">
            <a class="back-to-index d-xl-none d-md-none megasize" href="<?php echo base_url();?>teacher/message/"><i class="icon-feather-chevron-left"></i></a>          
            <div class="user-info">
                <img alt="" src="<?php echo $this->crud->get_image_url($re[0], $re[1]); ?>"> <?php echo $this->db->get_where($re[0], array($re[0] . '_id' => $re[1]))->row()->first_name." ".$this->db->get_where($re[0], array($re[0] . '_id' => $re[1]))->row()->last_name; ?>
            </div>
