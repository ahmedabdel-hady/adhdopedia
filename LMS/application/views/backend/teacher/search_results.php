				            ...
				            <?php  foreach($students as $row):?>
					            <li>
						            ...
						            <div class="notification-event">
							            <a href="<?php echo base_url();?>teacher/view_marks/<?php echo $row['student_id'];?>/" class="h6 notification-friend"><?php echo $this->crud->get_name('student', $row['student_id']) ;?></a>.
							            <?php $cl_id = $this->db->get_where('enroll', array('student_id' => $row['student_id']))->row()->class_id;?>
							            <span class="notification-date"><span class="badge badge-success"><?php echo $this->db->get_where('class', array('class_id' => $cl_id))->row()->name;?></span></span>
						            </div>
					            </li>
				                <?php endforeach;?>
				            </ul>
