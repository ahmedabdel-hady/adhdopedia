    <?php 
        $info = $this->db->get_where('deliveries', array('id' => $answer_id))->result_array();
	  	foreach($info as $row):
	    $time1 = $this->db->get_where('homework', array('homework_code' => $row['homework_code']))->row()->date_end; $time2 = $this->db->get_where('homework', array('homework_code' => $row['homework_code']))->row()->time_end; 
		$time = $time1. " ".$time2;	
	?>
	<div class="content-w">
	    <div class="conty">
	        ...
	        <div class="os-tabs-w menu-shad">
		        <div class="os-tabs-controls">
    		        <ul class="navs navs-tabs upper">
			            <li class="navs-item">
    			            <a class="navs-links" href="<?php echo base_url();?>teacher/homeworkroom/<?php echo $row['homework_code'];?>/"><i class="os-icon picons-thin-icon-thin-0014_notebook_paper_todo"></i><span><?php echo getEduAppGTLang('homework_details');?></span></a>
			            </li>
			            <li class="navs-item">
    			            <a class="navs-links active" href="<?php echo base_url();?>teacher/homework_details/<?php echo $row['homework_code'];?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo getEduAppGTLang('deliveries');?></span></a>
			            </li>
			            <li class="navs-item">
    			            <a class="navs-links" href="<?php echo base_url();?>teacher/homework_edit/<?php echo $row['homework_code'];?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo getEduAppGTLang('edit');?></span></a>
			            </li>
		            </ul>
    		    </div>
	        </div>
