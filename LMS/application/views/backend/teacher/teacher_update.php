          						    ...
          						    <div class="user-profile">
              							<div class="up-head-w" style="background-image:url(<?php echo base_url();?>public/uploads/bglogin.jpg)">
          								    <div class="up-main-info">
          								        ...
          								        <h3 class="text-white"><?php echo $this->crud->get_name('teacher', $row['teacher_id']);?></h3>
                                    			    ...
                                    			    <div class="row">   
                                        				<div class="col-sm-6">
                                        				    <div class="form-group">
                                            				    ...
                                            				    <input class="form-control" type="text" name="first_name" value="<?php echo $row['first_name'];?>" disabled="">
                                    				    ...
                                    				    <div class="col-sm-6"> 
                                            				<div class="form-group">
                                            				    ...
                                            				    <input class="form-control"  type="text" name="last_name" value="<?php echo $row['last_name'];?>" disabled="">
                                            				    <span class="material-input"></span>
                                        					    <span class="material-input"></span>
                                        				    </div>
                                    				    </div>
                                    				    ...
                                    				    <div class="col-sm-6"> 
                                        					<div class="form-group is-focused">
                            								    ...
                            								    <input type='text' class="datepicker-here" data-position='top left' value="<?php echo $row['birthday'];?>" data-language='en' name="birthday" data-multiple-dates-separator="/"/>
                    						    ...
                    						    <div class="help-support-block">
        										    ...
        										    <ul class="help-support-list">
        												<li>
        												    ...
        												    <a href="<?php echo base_url();?>teacher/my_account/"><?php echo getEduAppGTLang('personal_information');?></a>
        											    </li>
        											    <li>
        													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
        												    <a href="<?php echo base_url();?>teacher/teacher_update/"><?php echo getEduAppGTLang('update_information');?></a>
        											    </li>
        										    </ul>
        									    </div>
        								    </div>
                                            ...
                                            <div class="pricing-plans row no-gutters">
                                                <div class="pricing-plan col-sm-6">
                                                    ...
                                                    <div class="plan-body"><br><br>
                                                        ...
                                                        <?php else:?>
                                                            <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>teacher/my_account/remove_facebook/"><?php echo getEduAppGTLang('unlink');?></a>
                                                        <?php endif;?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="pricing-plan col-sm-6">
                                                    ...
                                                    <div class="plan-body"><br><br>
                                                        ...
                                                        <?php else:?>
                                                            <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>teacher/my_account/remove_google/"><?php echo getEduAppGTLang('unlink');?></a>
                                                        <?php endif;?>
                                                        </div>
                                                    </div>
                                                </div>
