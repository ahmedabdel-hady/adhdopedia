                                ...
                                <article class="hentry post thumb-full-width">                
                                    <div class="post__author author vcard inline-items">
                                        ...
                                        <div class="author-date">
                                            <a class="h6 post__author-name fn" href="javascript:void(0);"><?php echo getEduAppGTLang('marks');?> <small>(<?php echo $this->db->get_where('exam', array('exam_id' => $exam_id))->row()->name;?>)</small>.</a>
                                        </div>                
                                    </div>                
                                    <div class="edu-posts cta-with-media">
                                        ...
                                        <?php echo form_open(base_url() . 'teacher/marks_update/'.$exam_id.'/'.$ex[0].'/'.$ex[1].'/'.$ex[2]);?>
